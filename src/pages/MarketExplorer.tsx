// BASED DATA - Market Explorer — Contract Explorer
import { useState, useEffect, useMemo } from 'react';
import { useQuery } from '@tanstack/react-query';
import { Link, useSearchParams, useNavigate } from 'react-router-dom';
import {
  Search, Filter, Download, Building2, DollarSign,
  BookmarkPlus, ChevronRight, Loader2, Compass, Users, Shield,
} from 'lucide-react';
...
export default function MarketExplorer() {
  ...
  return (
    <GlobalLayout>
      <PageSEO title="Market Explorer — Government Contracts" description="Explore federal contracts and entities. Filter by state, agency, NAICS, and set-aside type." path="/explore" />
          ...
          <div className="container py-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Explore federal contracts, entities, and market intelligence</p>
              </div>
